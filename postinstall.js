...
console.log('');
console.log('  Fix (run in your bash terminal):');
console.log('    rm ~/.local/bin/ba-kit');
console.log('');
console.log('  Then use any ba-kit command normally:');
console.log('    ba-kit uninstall   # to uninstall');
console.log('    ba-kit install     # to install/reinstall');
console.log('    ba-kit update      # to update');
console.log('');
